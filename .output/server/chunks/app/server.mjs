...
const _47Users_47meetqy_47Desktop_47nuxt_45temp_47plugins_47mock_46ts = defineNuxtPlugin(() => {
  return {
    provide: {
      Mock: mockjs,
...
const _plugins = [
  preload,
  _47Users_47meetqy_47Desktop_47nuxt_45temp_47_46nuxt_47components_46plugin_46mjs,
  _47Users_47meetqy_47Desktop_47nuxt_45temp_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin,
  _47Users_47meetqy_47Desktop_47nuxt_45temp_47node_modules_47nuxt_47dist_47head_47runtime_47plugin,
  _47Users_47meetqy_47Desktop_47nuxt_45temp_47node_modules_47nuxt_47dist_47pages_47runtime_47router,
  _47Users_47meetqy_47Desktop_47nuxt_45temp_47plugins_47mock_46ts
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "drawer drawer-mobile" }, _attrs))}><input id="my-drawer-2" type="checkbox" class="drawer-toggle"><div class="drawer-content flex flex-col items-center justify-center relative"><div class="h-12 bg-base-200 w-full absolute left-0 top-0 flex justify-end px-4 items-center"><div class="dropdown dropdown-end"><label tabindex="0" class="btn btn-sm m-1 capitalize">language</label><ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 uppercase"><li>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "/zh/card/1" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` \u{1F1E8}\u{1F1F3} <span class="ml-1"${_scopeId}>zh</span>`);
          } else {
            return [
              vue_cjs_prod.createTextVNode(" \u{1F1E8}\u{1F1F3} "),
              vue_cjs_prod.createVNode("span", { class: "ml-1" }, "zh")
            ];
          }
        }),
        _: 1
      ...
      _push(`</li><li>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "/en/card/1" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` \u{1F1FA}\u{1F1F8} <span class="ml-1"${_scopeId}>en</span>`);
          } else {
            return [
              vue_cjs_prod.createTextVNode(" \u{1F1FA}\u{1F1F8} "),
              vue_cjs_prod.createVNode("span", { class: "ml-1" }, "en")
            ];
          }
        }),
        _: 1
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "bg-base-100 rounded-lg border border-base-200 shadow-md" }, _attrs))}><div class="flex justify-end px-4 pt-4"><button id="dropdownButton" data-dropdown-toggle="dropdown" class="btn btn-ghost" type="button"><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z"></path></svg></button></div><div class="flex flex-col items-center pb-10 px-24"><img class="mb-3 w-24 h-24 rounded-full shadow-lg" src="https://wcao.cc/image-space/api/avatar"><h5 class="mb-1 text-xl font-medium text-base-content text-opacity-90">${serverRenderer.exports.ssrInterpolate(useLanguage({
    en: _ctx.$Random.name(),
    zh: _ctx.$Random.cname()
  }, _ctx.$route))}</h5><span class="text-sm text-base-content text-opacity-50">${serverRenderer.exports.ssrInterpolate(useLanguage({
    en: _ctx.$Random.title(2),
    zh: _ctx.$Random.ctitle(4, 6)
  }, _ctx.$route))}</span><div class="flex mt-4 space-x-3 lg:mt-6"><a href="#" class="btn btn-sm capitalize">${serverRenderer.exports.ssrInterpolate(useLanguage({
    en: _ctx.$Random.title(2),
    zh: _ctx.$Random.ctitle(4, 6)
  }, _ctx.$route))}</a><a href="#" class="btn btn-outline btn-sm capitalize">${serverRenderer.exports.ssrInterpolate(useLanguage({
    en: _ctx.$Random.word(),
    zh: _ctx.$Random.cword(4)
  }, _ctx.$route))}</a></div></div></div>`);
}
