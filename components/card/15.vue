<template>
  ...
  >
    <div class="card overflow-visible">
      <div
        class="card-header mx-4 -mt-6 max-h-[400px] rounded-lg overflow-hidden"
      >
        <a href="https://wcao.cc" blur-shadow-image="true">
          <img
            class="w-full"
      ...
      <div class="card-body">
        ...
        <button class="btn capitalize" data-ripple-light="true">
          Read More
        </button>
      </div>
    </div>
